#include "data_utils.hh"

DataUtil::DataUtil(size_t batch_size, size_t number_of_batches) :
...
int DataUtil::getNumOfBatches() {
	return number_of_batches;
}

std::vector<Matrix>& DataUtil::getBatches() {
	return batches;
}

std::vector<Matrix>& DataUtil::getTargets() {
	return targets;
}
